-- Manual creation script for user_alert_stats table
-- Run this if the table doesn't exist

-- Check if table exists and create if not
CREATE TABLE IF NOT EXISTS user_alert_stats (
...
-- Initialize stats for existing users (run this after table creation)
INSERT IGNORE INTO user_alert_stats (user_id, subscription_id, is_subscription_active, total_alert_count, remaining_alert_count, max_alerts_allowed)
SELECT 
    u.id as user_id,
    u.subscription_id,
    CASE 
